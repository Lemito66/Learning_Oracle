create
or replace function fun_prescripcion_interconsulta (vAtendimento number) return clob is vResultado clob;

begin
SELECT
  upper(t4.ds_itpre_med) prescripcion_ic INTO vResultado
from
  pre_med t1,
  itpre_med t4,
  tip_presc t7,
...
end fun_prescripcion_interconsulta;
