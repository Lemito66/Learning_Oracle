...
SELECT
    ...
    fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'SISTOLICA') || ' / ' || fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'DIASTOLICA') PRESION_ARTERIAL_CONCATENADA, -- 102
    fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'CARDIACA') FRECUENCIA_CARDIACA, -- 103
    fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'RESPIRATORIA') FRECUENCIA_RESPIRATORIA, -- 104
    fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'OXIGENO') PULSIOXEMETRIA, -- 105 
    fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'CEFÁLICO') PERIMETRO_CEFALICO, -- 106 
    FUN_SIGNOS_VITALES_U (A.CD_ATENDIMENTO, 8) PESO, -- 107
    FUN_SIGNOS_VITALES_U (A.CD_ATENDIMENTO, 9) TALLA, -- 108
    fun_signos_vitales_008 (A.CD_ATENDIMENTO, 'GLICEMIA') GLICEMIA_CAPILAR, -- 109 
    fun_medidas_008 (A.CD_ATENDIMENTO, 'OCULAR') OCULAR, -- 110
    fun_medidas_008 (A.CD_ATENDIMENTO, 'VERBAL') VERBAL, -- 111
...
-- ANTECEDENTE,  Solo EXAMEN FISICO
BEGIN
SELECT
    (
        SELECT
