CREATE OR REPLACE PROCEDURE PRC_INSERTA_T_TMP_008_2023(
    VATENDIMENTO NUMBER
) IS
...
BEGIN
 ...
 -- PLANES DE EGRESO
            'INDICACIONES'
                                 ...
                                 ||'---------------------'
                                 ||CHR(10)
                                 ||PLANES_TRATAMIENTO                                                   PLAN_TRATAMIENTO_1,
    ...
    BEGIN
        SELECT
            ...
            (
                ...
                WHERE
                    X.CD_CAMPO IN (293670, 261292, 297052, 297214, 320538, 320758, 343291, 97907, 349991, 373231, 374652, 375081, 429896)
 ...
 -- MOTIVO DE ATENCION
    BEGIN
        SELECT
            DECODE(A.DETALLE_EVENTO, 'ACCIDENTE DE TRÁNSITO', 'true', 'false')     ACCIDENTE_TRANSITO,
        ...
        SELECT
            ...
            (
                ...
                WHERE
                    ...
                    AND A.CD_PRE_MED=B.CD_PRE_MED
                    AND B.CD_TIP_ESQ IN ('EXI')
                    AND B.CD_TIP_PRESC IN (766, 765, 767, 716, 715, 717, 713, 712, 714, 734, 733, 989, 990, 729, 985, 730, 986, 996, 740, 739, 995, 731, 987, 732, 988, 696, 695, 697, 699, 698, 700, 702, 701, 703, 707, 706, 708, 693, 694, 681, 680, 682, 743, 997, 744, 998, 758, 688, 687, 689, 685, 686, 741, 742, 726, 759, 764, 727, 983, 728, 984, 737, 993, 738, 994, 735, 991, 736, 992, 745, 999, 746, 1000, 719, 718, 720, 762, 763, 753, 1007, 754, 1008, 749, 1003, 750, 1004, 710, 709, 711, 756, 757, 747, 1001, 748, 1002, 691, 690, 692, 683, 684, 751, 1005, 752, 1006, 704, 705, 760, 722, 721, 723)
                    AND NVL(B.SN_CANCELADO, 'N')='N'
            ) RESONANCIA,
            (
                SELECT
            ...
            (
                ...
                WHERE
                    A.CD_ATENDIMENTO=VATENDIMENTO
                    AND A.CD_PRE_MED=B.CD_PRE_MED
                    AND B.CD_TIP_PRESC NOT IN (183, 184, 315, 316, 1587, 1588, 632, 564, 565, 875, 805, 807, 806, 808, 876, 1016, 853, 1015, 854, 840, 850, 1012, 860, 859, 1021, 820, 799, 800, 843, 1014, 851, 1013, 852, 795, 796, 879, 871, 872, 873, 818, 793, 794, 801, 802, 842, 798, 809, 844, 847, 870, 1011, 1010, 848, 845, 846, 1020, 857, 1019, 858, 1017, 856, 1018, 1024, 1023, 862, 797, 813, 810, 811, 812, 1031, 1030, 869, 1027, 816, 864, 863, 1026, 830, 804, 867, 1029, 1028, 874, 803, 824, 814, 893, 376, 306, 678, 677, 679, 676, 631, 635, 561, 562, 563, 631, 635, 561, 562, 563, 766, 765, 767, 716, 715, 717, 713, 712, 714, 734, 733, 989, 990, 729, 985, 730, 986, 996, 740, 739, 995, 731, 987, 732, 988, 696, 695, 697, 699, 698, 700, 702, 701, 703, 707, 706, 708, 693, 694, 681, 680, 682, 743, 997, 744, 998, 758, 688, 687, 689, 685, 686, 741, 742, 726, 759, 764, 727, 983, 728, 984, 737, 993, 738, 994, 735, 991, 736, 992, 745, 999, 746, 1000, 719, 718, 720, 762, 763, 753, 1007, 754, 1008, 749, 1003, 750, 1004, 710, 709, 711, 756, 757, 747, 1001, 748, 1002, 691, 690, 692, 683, 684, 751, 1005, 752, 1006, 704, 705, 760, 722, 721, 723, 890, 891, 920)
                    AND NVL(B.SN_CANCELADO, 'N')='N'
            ) OTROS,
