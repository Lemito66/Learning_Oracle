CREATE
OR REPLACE PROCEDURE PRC_INSERTA_T_SONDAS_ALI (
  V_CD_FORMULARIO NVARCHAR2,
...
SET
  ...
  FECHA_CAMBIO = V_FECHA_CAMBIO,
  FECHA_RETIRO = V_FECHA_RETIRO,
  TIPO = V_TIPO,
