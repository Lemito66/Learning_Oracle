create
or replace procedure prc_inserta_t_anamnesis (
    ...
    v_estado CHAR,
    v_usuario CHAR,
    v_motivo_consulta_1 VARCHAR2,
    v_motivo_consulta_2 VARCHAR2,
    v_motivo_consulta_3 VARCHAR2,
    v_motivo_consulta_4 VARCHAR2,
    v_enfermedad_actual VARCHAR2,
    v_cd_anamnesis NUMBER,
    v_nutricional VARCHAR2,
    v_funcional VARCHAR2,
    v_cognitiva VARCHAR2,
    v_general VARCHAR,
    v_datos_filiacion VARCHAR2
) is vSecuencial number;

begin
--if nvl(v_motivo_consulta_1,'x')<>'x' then
select
    seq_anamnesis.nextval into vSecuencial
from
    dual;
