SELECT
    ...
    P.CD_ATENDIMENTO                                                CODIGO_ATENCION,
...
WHERE
 ...
 --AND P.CD_ATENDIMENTO = {V_VAR_CD_ATENDIMENTO}
 ...
 --AND C.DH_PROCESSO BETWEEN TO_DATE('{V_VAR_FECHA_INICIO}', 'DD/MM/YYYY') AND TO_DATE('{V_VAR_FECHA_FIN}', 'DD/MM/YYYY')
    AND C.DH_PROCESSO BETWEEN TO_DATE('06/01/2023', 'DD/MM/YYYY') AND TO_DATE('06/01/2024', 'DD/MM/YYYY')